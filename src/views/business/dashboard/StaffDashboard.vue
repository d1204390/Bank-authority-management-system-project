# views/business/dashboard/StaffDashboard.vue
<template>
            ...
            <el-col :xs="12" :sm="6">
              <el-card class="stat-card">
                <div class="stat-content">
                  ...
                  <div class="stat-info">
                    <div class="stat-value">{{ stats.processingCases }}</div>
            ...
            <div class="section-container">
              ...
              <el-card class="function-card">
                ...
                <div class="function-content">
                  <el-row :gutter="10">
                    <el-col :span="12">
                      <el-button type="primary" @click="handleBusinessProcess">
                        處理業務
                      </el-button>
                    </el-col>
                    <el-col :span="12">
                      <el-button @click="viewBusinessHistory">
                        歷史紀錄
                      </el-button>
                    </el-col>
                  </el-row>
                  <div class="business-tasks" v-if="businessTasks.length">
                    <h4>待處理項目</h4>
                    <el-scrollbar height="150px">
                      <ul class="task-list">
                        <li v-for="task in businessTasks" :key="task.id">
                          <span>{{ task.name }}</span>
...
import { Document, Loading, SuccessFilled, Warning, Briefcase, Calendar } from '@element-plus/icons-vue'
...
const userDepartment = computed(() => userInfo.department || 'BD')
...
const initDashboard = async () => {
  try {
    ...
    businessTasks.value = [
      { id: 1, name: '新客戶開發專案', priority: 'high' },
      { id: 2, name: '客戶關係維護會議', priority: 'normal' },
      { id: 3, name: '產品方案提案準備', priority: 'high' }
    ]
  } catch (error) {
...
// 處理業務
const handleBusinessProcess = () => {
  // 導航到業務處理頁面
}

// 查看業務紀錄
const viewBusinessHistory = () => {
  // 導航到業務紀錄頁面
}
